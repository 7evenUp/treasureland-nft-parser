...
def get_total_nfts_from_json(dirname):
    total_nfts_list = []
    ...
    for date_dirname in os.listdir(f"./data/{dirname}"):
        ...
        total_nfts_list.append(data[0]["total_nfts"])

    return total_nfts_list
...
def main():
    ...
    for dirname in os.listdir('./data'):
        ...
        total_nfts_list = get_total_nfts_from_json(dirname)
        row = [dirname]
        for price in total_nfts_list:
            row.append(price)
